...
- **Accept match:** Press Tab or Esc to accept the current match and continue editing. Press Enter to accept and execute the command immediately
- **Cancel search:** Press Ctrl+C to cancel and restore your original input. Press Backspace on empty search to cancel
